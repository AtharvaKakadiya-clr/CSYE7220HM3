...
import Song2 from "../pages/song2/song2"
import Song3 from "../pages/song3/song3"
      ...
      <Router history={history} title={title} >
        ...
        >
          ...
          <List>
            ...
            <ListItem button component={Link} to="/song2" onClick={onItemClick('Song2')}>
              <ListItemIcon>
                <DashboardIcon />
              </ListItemIcon>
              <ListItemText primary="Song2" />
              { title === 'Song2' && 
                <ListItemIcon>
                  <IconButton onClick={handleDrawerCollapsed}>
                    <ChevronLeftIcon />
            ...
            <ListItem button component={Link} to="/song3" onClick={onItemClick('Song3')}>
              <ListItemIcon>
                <DashboardIcon />
              </ListItemIcon>
              <ListItemText primary="Song3" />
              { title === 'Song3' && 
                <ListItemIcon>
                  <IconButton onClick={handleDrawerCollapsed}>
                    <ChevronLeftIcon />
